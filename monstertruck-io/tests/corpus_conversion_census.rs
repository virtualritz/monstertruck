...
use monstertruck_io::step::load::{SurfaceAny, Table, step_geometry::Surface};
...
fn fate_of(table: &Table, holder: &monstertruck_io::step::load::FaceSurfaceHolder) -> Fate {
...
fn face_geometry_id(holder: &monstertruck_io::step::load::FaceSurfaceHolder) -> Option<u64> {
...
fn outer_shell(
    table: &Table,
    solid: &monstertruck_io::step::load::ManifoldSolidBrepHolder,
) -> Option<monstertruck_io::step::load::ShellHolder> {
